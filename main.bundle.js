...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => /* binding */ ImageApiService\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar API_KEY = '18968535-a98ecca7bd1b0403c78b07ef3';\n\nvar ImageApiService = /*#__PURE__*/function () {\n  function ImageApiService() {\n    _classCallCheck(this, ImageApiService);\n\n    this.searchQuery = '';\n    this.page = 1;\n  }\n\n  _createClass(ImageApiService, [{\n    key: \"fetchImageByName\",\n    value: function fetchImageByName() {\n      var _this = this;\n\n      var url = \"https://pixabay.com/api/?image_type=photo&orientation=horizontal&q=\".concat(this.searchQuery, \"&page=\").concat(this.page, \"&per_page=12&key=\").concat(API_KEY, \"\\n\");\n      return fetch(url).then(function (response) {\n        return response.json();\n      }).then(function (images) {\n        if (images.hits.length) {\n          _this.incrementPage();\n\n          return images;\n        }\n\n        _this.sayNothigFound();\n      });\n    }\n  }, {\n    key: \"incrementPage\",\n    value: function incrementPage() {\n      this.page += 1;\n    }\n  }, {\n    key: \"resetPage\",\n    value: function resetPage() {\n      this.page = 1;\n    }\n  }, {\n    key: \"sayNothigFound\",\n    value: function sayNothigFound() {\n      return alert('Oh no! Nothig found! Please enter something specific for query!');\n    }\n  }, {\n    key: \"query\",\n    get: function get() {\n      return this.searchQuery;\n    },\n    set: function set(newQuery) {\n      this.searchQuery = newQuery;\n    }\n  }]);\n\n  return ImageApiService;\n}();\n\n\n\n//# sourceURL=webpack://goit-js-hw-13-image-finder/./src/apiService.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var lodash_debounce__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash.debounce */ \"./node_modules/lodash.debounce/index.js\");\n/* harmony import */ var lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_debounce__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _apiService_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./apiService.js */ \"./src/apiService.js\");\n/* harmony import */ var _components_load_more_btn__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/load-more-btn */ \"./src/components/load-more-btn.js\");\n;\n\nvar searchFormTemplate = __webpack_require__(/*! ./templates/search-form-markup_template.hbs */ \"./src/templates/search-form-markup_template.hbs\");\n\nvar imageCardTemplate = __webpack_require__(/*! ./templates/image-card-template.hbs */ \"./src/templates/image-card-template.hbs\");\n\n\n\n // создаем экземпляры классов для API и кнопки догрузки\n\nvar imageApiService = new _apiService_js__WEBPACK_IMPORTED_MODULE_2__.default();\nvar loadMoreBtn = new _components_load_more_btn__WEBPACK_IMPORTED_MODULE_3__.default({\n  selector: '[data-action=\"load-more\"]',\n  hidden: true\n});\nvar body = document.querySelector('body');\nvar gallery = document.querySelector('.gallery'); // функция рендера разметки поиска\n\nfunction searchFormMarkup() {\n  body.insertAdjacentHTML('afterbegin', searchFormTemplate());\n}\n\nsearchFormMarkup();\nvar searchForm = document.querySelector('#search-form'); // события инпута и кнопки догрузки\n\nsearchForm.addEventListener('input', lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(onSearch, 1000));\nloadMoreBtn.refs.button.addEventListener('click', fetchImages); // функция поиска по инпуту\n\nfunction onSearch(e) {\n  // использую \"trim()\", т.к. бэкенд поддерживает запросы с пробелом\n  imageApiService.query = e.target.value.trim();\n\n  if (imageApiService.query === '') {\n    return alert('Please enter something specific for query!');\n  }\n\n  loadMoreBtn.show();\n  imageApiService.resetPage();\n  clearImagesGallery();\n  fetchImages();\n} // функция обработки данных из API\n\n\nfunction fetchImages() {\n  loadMoreBtn.disable();\n  imageApiService.fetchImageByName().then(function (images) {\n    if (images) {\n      imageGalleryMarkup(images);\n      loadMoreBtn.enable();\n      window.scrollTo({\n        top: imageApiService.page * 10000,\n        behavior: 'smooth'\n      });\n    }\n  })[\"catch\"](function (error) {\n    return console.log(error);\n  });\n} // функция рендера галлереи\n\n\nfunction imageGalleryMarkup(images) {\n  images.hits.map(function (el) {\n    var image = document.createElement('li');\n    var imageCardMarukp = imageCardTemplate(el);\n    image.insertAdjacentHTML('afterbegin', imageCardMarukp);\n    gallery.append(image);\n  });\n} // функция очистки галлереи при новом поиске\n\n\nfunction clearImagesGallery() {\n  if (gallery.children) {\n    gallery.innerHTML = '';\n  }\n}\n\n//# sourceURL=webpack://goit-js-hw-13-image-finder/./src/index.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => "8ca9a03ff7af1fa103eb"
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "goit-js-hw-13-image-finder:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdategoit_js_hw_13_image_finder"] = (chunkId, moreModules, runtime) => {
